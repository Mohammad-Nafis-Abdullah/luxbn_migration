  ...
  uk: [
    {
      ...
      scholarship: "15%-25% Scholarship for Masters & Pre-Masters programs",
      tuitionFees: "£13,000 - £17,000/year",
      extraDetails: "Located in London; popular for business and IT programs.",
    },
    {
      name: "UWE Bristol",
    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <aside className="w-24 md:w-48 border-r bg-white shadow-sm">
        <ul className="flex md:flex-col justify-between md:justify-start overflow-x-auto">
          {countries.map((country) => (
            ...
            >
              <span className="text-2xl md:text-xl">{country.icon}</span>
              <span className="text-sm md:ml-2 md:mt-1">{country.name}</span>
            </li>
          ))}
        </ul>
      </aside>
      ...
      <main className="flex-1 p-5 md:p-10">
        ...
        <div className="space-y-8">
          {scholarships[activeCountry]?.map((uni: { name: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; description: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; scholarship: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; tuitionFees: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; extraDetails: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; logo: string | Blob | undefined; }, idx: Key | null | undefined) => (
            <div
              key={idx}
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-700 mt-2">{uni.description}</p>
